...
public:
    ...
    {
        AdminClase->setWindowTitle(QApplication::translate("AdminClase", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("AdminClase", "Administrar Clase", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("AdminClase", "Tab 1", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("AdminClase", "Tab 2", Q_NULLPTR));
    } // retranslateUi
