...
public:
    ...
    void retranslateUi(QWidget *AdminEmpleado)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("AdminEmpleado", "Tab 1", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("AdminEmpleado", "Tab 2", nullptr));
    } // retranslateUi
