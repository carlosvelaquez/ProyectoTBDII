...
public:
    ...
    void retranslateUi(QWidget *AdminLicencia)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("AdminLicencia", "Tab 1", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("AdminLicencia", "Tab 2", nullptr));
    } // retranslateUi
